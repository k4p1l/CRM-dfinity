...
import { idlFactory } from './NewCrm_frontend.did.js';
export { idlFactory } from './NewCrm_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NEWCRM_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./NewCrm_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the NewCrm_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./NewCrm_frontend.did.js")._SERVICE>}
 */
export const NewCrm_frontend = createActor(canisterId);
