...
import { idlFactory } from './NewCrm_backend.did.js';
export { idlFactory } from './NewCrm_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NEWCRM_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./NewCrm_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the NewCrm_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./NewCrm_backend.did.js")._SERVICE>}
 */
export const NewCrm_backend = createActor(canisterId);
